  ...
  <main class="content">
    <section class="desk">
      ...
      <div class="desk__header">
        ...
        <button class="desk__add" type="button" data-test="desk-add" @click="columnsStore.addColumn">Добавить столбец</button>
        ...
        <div class="desk__filters">
          ...
          <div class="desk__meta-filter">
            ...
            <ul class="meta-filter">
              ...
              >
                <a class="meta-filter__status" :class="`meta-filter__status meta-filter__status--color meta-filter__status--${value}`" :title="label" />
              </li>
            </ul>
          </div>
        </div>
      ...
      <div v-if="columnsStore.columns.length" class="desk__columns">
        <!--        Показываем колонки-->
        <desk-column v-for="column in columnsStore.columns" :key="column.id" :column="column" @update="columnsStore.updateColumn" @delete="columnsStore.deleteColumn" />
      </div>
    </section>
  </main>
</template>
