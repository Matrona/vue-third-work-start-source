    ...
    <section class="task-card__wrapper">
      ...
      <div class="task-card__status">
        ...
        <ul class="meta-filter task-card__meta">
          <li v-for="({ value, label }) in statusList" :key="value" class="meta-filter__item"
            :class="{ active: value === taskStatuses[task.statusId] }" @click="setStatus(value)">
      ...
      <div class="task-card__block">
        <div class="task-card__links">
          ...
          <div class="task-card__links-item">
            ...
            <!--            Описание ссылки-->
            <input v-model="task.urlDescription" type="text" name="task_link_desc"
      ...
      <div class="task-card__block">
        <!--        Список подзадач-->
        <task-card-view-ticks-list :ticks="task.ticks" @createTick="createTick" @updateTick="updateTick"
      ...
      <div class="task-card__buttons">
        ...
        <app-button class="button--primary" :class="{ 'button--disabled': !isFormValid }" :disabled="!isFormValid"
          @click="submit">
          Сохранить
        </app-button>
      </div>
