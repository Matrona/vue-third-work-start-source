...
import { DAY_IN_MILLISEC, TAG_SEPARATOR, MONTH_IN_SEC, YEAR_IN_SEC, DAY_IN_SEC, HOUR_IN_SEC, MINUTE_IN_SEC } from "./constants";

// разделяет массив по определённому идентификатору
