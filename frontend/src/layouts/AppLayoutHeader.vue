<template>
  <header class="header">
    ...
    <form action="#" class="header__search">
      <input type="search" name="search" required placeholder="Поиск" @input="filtersStore.applyFilters({ item: $event.target.value, entity: 'search' })" />
      <button type="submit">Найти</button>
    </form>
    <!--    Кнопка создания новой задачи-->
    <router-link v-if="authStore.getUserAttribute('isAdmin')" to="/tasks/create" class="header__create-task"> Создать карточку </router-link>
    <!--    Аватар пользователя-->
